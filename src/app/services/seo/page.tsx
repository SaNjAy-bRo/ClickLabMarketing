    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-slate-900 tracking-tight mb-8 leading-tight">
              Dominate Rankings with <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">SEO Mastery</span>
            </h1>
            <p className="text-xl md:text-2xl text-slate-600 mb-10 leading-relaxed font-medium max-w-3xl mx-auto">
              Paid ads stop when the budget runs out. Organic growth is forever. We implement proven technical SEO, robust content strategies, and safe backlink acquisition to secure the top spots on Google.
            </p>
      ...
      <section className="py-24 bg-blue-600 text-white">
        <div className="container mx-auto px-4 md:px-8 text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-black mb-6">Start Climbing the Google Rankings.</h2>
          <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto font-medium">
            Stop relying solely on paid ads. Build a sustainable moat around your business with long-term organic growth.
          </p>
          <Link href="/contact">
