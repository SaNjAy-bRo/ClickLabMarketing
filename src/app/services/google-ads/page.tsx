    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-black text-slate-900 tracking-tight mb-8 leading-tight">
              Scale Profitably with <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">Google Ads Management</span>
            </h1>
            <p className="text-xl md:text-2xl text-slate-600 mb-10 leading-relaxed font-medium max-w-3xl mx-auto">
              Stop wasting ad spend on broad terms. We build high-intent search campaigns and retargeting display strategies that capture ready-to-buy customers at the precise moment they are searching for your solution.
            </p>
      ...
      <section className="py-24 bg-blue-600 text-white">
        <div className="container mx-auto px-4 md:px-8 text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-black mb-6">Stop Wasting Ad Spend Today.</h2>
          <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto font-medium">
            Let our certified experts take over your account to drastically lower your CPA and scale your revenue.
          </p>
          <Link href="/contact">
