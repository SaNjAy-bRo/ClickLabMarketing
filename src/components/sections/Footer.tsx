        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-20 border-b border-gray-800 pb-20">
          ...
          <div className="lg:col-span-4 pr-8">
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.linkedin.com/company/click-lab-marketing" target="_blank" rel="noopener" className="w-12 h-12 flex items-center justify-center bg-gray-800 hover:bg-blue-600 rounded-full transition-all duration-300 text-white hover:scale-110 shadow-lg">
